...
# attempting a build.
#
# Install  the  CHICKEN  egg  "simple-exceptions"  under  the  directory
# "/usr/local".  We assume  the script is run from the  top directory of
# the build tree.
...
function main () {
    (umask 0; sudo chicken-install simple-exceptions)
}
